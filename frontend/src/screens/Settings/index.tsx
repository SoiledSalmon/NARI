  ...
  return (
    ...
    >
      ...
      <Card style={[styles.deviceCard, deviceDisconnected && styles.deviceCardDisconnected]}>
        <View style={styles.deviceRow}>
          ...
          <TouchableOpacity
            ...
            accessibilityLabel="Manage NARI belt"
          >
      ...
      <SettingsRow
        ...
        onPress={() => navigation.navigate(ROUTES.SETTINGS_STACK.PERSONAL_INFO)}
      />
      <SettingsRow
        ...
        onPress={() => navigation.navigate(ROUTES.SETTINGS_STACK.EMERGENCY_CONTACTS)}
      />
      <SettingsRow
        title={t('settings.alertPreferences')}
        subtitle={t('settings.alertPreferencesSubtitle')}
        onPress={() => navigation.navigate(ROUTES.SETTINGS_STACK.ALERT_PREFERENCES)}
        rightAccessory={
          <Toggle
            value={silentMode}
      ...
      <SettingsRow
        ...
        onPress={() => navigation.navigate(ROUTES.SETTINGS_STACK.PRIVACY_SECURITY)}
        rightAccessory={
          <Toggle
      ...
      <SettingsRow
        ...
        onPress={() => navigation.navigate(ROUTES.SETTINGS_STACK.LANGUAGE_SETTINGS)}
      />
      <SettingsRow
        title={t('settings.help')}
        subtitle={t('settings.helpSubtitle')}
        onPress={() => navigation.navigate(ROUTES.SETTINGS_STACK.HELP_SUPPORT)}
      />
      <SettingsRow
