  ...
  const handleConnect = async (deviceName: string) => {
    ...
    try {
      ...
      if (success) {
        ...
        throw new Error('Failed to connect to belt');
      }
    } catch (error: any) {
      haptic.error();
      setState('error');
      ...
      <View style={styles.content}>
        ...
        {state === 'error' && (
          <Card style={styles.emptyCard}>
            <Text style={styles.emptyTitle}>No belt found</Text>
            <Text style={styles.emptyText}>
              Ensure your NARI belt is powered on and connected to the same WiFi network, then try again.
            </Text>
            <Button
              title="Search again"
              onPress={scanForBelt}
