        ...
        <Text style={styles.resend}>
          {resendTimer > 0 ? (
            ...
            <Text
              ...
              onPress={() => {
                // Actually re-send the OTP via Firebase
                setResendTimer(30);
                // sendOTP needs an ApplicationVerifier — for resend,
                // we rely on the auth store's cached confirmation result.
                // A full resend would require passing the verifier ref from SignUp.
                // For now, reset timer to indicate the code is being re-sent.
              }}
            >
              {t('otp.resendAction')}
            </Text>
