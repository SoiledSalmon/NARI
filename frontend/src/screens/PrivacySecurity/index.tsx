...
export default function PrivacySecurityScreen({ navigation }: Props) {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.row}><Text style={styles.rowLabel}>Location Sharing</Text><Text style={styles.rowValue}>Enabled</Text></View>
      <View style={styles.row}><Text style={styles.rowLabel}>Data Collection</Text><Text style={styles.rowValue}>Minimal</Text></View>
      <View style={styles.row}><Text style={styles.rowLabel}>Account Deletion</Text><Text style={styles.rowValue}>→</Text></View>
    </ScrollView>
  );
}
