...
export interface IDataProvider {
  ...
  /** Get the current calibration state of the belt sensors. */
  ...
  /** Initiate scan for the belt. Returns discovered device names. */
  scanForDevices(): Promise<string[]>;

  /** Connect to a discovered belt device by name. */
  connectToDevice(deviceName: string): Promise<boolean>;

  /** Disconnect the currently paired belt. */
